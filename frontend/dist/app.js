...
import { GAME_EVENTS, PLAYER_EVENTS, ROOM_EVENTS, SWITCH_EVENTS, WS_EVENETS } from "./constant.js";
...
ws.on(PLAYER_EVENTS.MESSAGE, ({
  ...
  room.messages.value = [...room.messages.value, {
    name,
    message
  }];
});
